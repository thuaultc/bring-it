...
class App extends Component {
    render() {
        ...
        const eventDesc = {
            ...
            "address": "14 rue tabaga 12001 perdu sous bois",
            "description": "ca va être cool",
        }

        return <Event name={eventDesc.name} eventDate={eventDesc.eventDate} creationDate={eventDesc.creationDate} address={eventDesc.address} description={eventDesc.description} items={items} />
        return (
            <div>
